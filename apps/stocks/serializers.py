...
class StockSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Stock
        fields = ['id', 'symbol', 'name', 'sector', 'industry', 'is_active', 'created_at']
...
class StockPriceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StockPrice
        fields = [
            'id', 'stock', 'stock_symbol', 'stock_name', 'price', 'volume', 
            'high', 'low', 'open_price', 'close_price', 'timestamp', 'created_at'
        ]
